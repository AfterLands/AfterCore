 ...
 *
 * <p><b>Legacy Methods (Path-based):</b> Simple message resolution from messages.yml</p>
 * <p><b>I18n Methods (MessageKey-based):</b> Advanced i18n with per-player language support</p>
 *
 * <p>When AfterLanguage plugin is installed, i18n methods provide full translation capabilities.
 * Otherwise, they fall back to simple message resolution.</p>
 *
...
public interface MessageService {
     ...
     *
     * @deprecated Use {@link #send(Player, MessageKey, Placeholder...)} for i18n support
     */
    @Deprecated
     ...
     * @deprecated Use {@link #get(Player, MessageKey, Placeholder...)} for i18n support
     */
    @Deprecated
    @NotNull
     ...
     *
     * <p>If AfterLanguage is installed, uses player's configured language.
     * Otherwise, falls back to simple message resolution.</p>
     *
     ...
     *
     * <p>Selects between .one and .other variants based on count.</p>
     *
     * @param player Player recipient
     ...
     *
     * <p>Useful for config scanner integration where fallback to original text is needed.</p>
     *
     * @param player Player for language resolution
     * @param key Translation key
     * @param defaultValue Fallback value if translation doesn't exist
     * @param placeholders Placeholders to replace
     * @return Translated string or defaultValue
     */
    @NotNull
    String getOrDefault(@NotNull Player player, @NotNull MessageKey key, @NotNull String defaultValue, @NotNull Placeholder... placeholders);
     ...
     */
    void sendBatch(@NotNull Player player, @NotNull List<MessageKey> keys, @NotNull Map<String, Object> sharedPlaceholders);
