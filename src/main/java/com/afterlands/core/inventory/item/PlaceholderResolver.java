 ...
 * </p>
 *
 * <p><b>Thread Safety:</b> PlaceholderAPI resolution MUST run on main thread.
 * Use SchedulerService.runSync() para PlaceholderAPI calls.</p>
 *
 * <p><b>Cache:</b> Placeholders resolvidos são cacheados por 5s (TTL curto
 * para evitar dados stale).</p>
 *
 * <p><b>Performance:</b> Timeout de 10 iterações para evitar infinite loops.</p>
 */
public class PlaceholderResolver {
     ...
     *
     * <p>Usa cache quando possível. Se player != null e PlaceholderAPI disponível,
     * resolve %placeholders%.</p>
     *
     * <p><b>CRITICAL:</b> Este método DEVE ser chamado da main thread se player != null.</p>
     *
     ...
     *
     * <p>Útil para pré-processar textos que não dependem de player.</p>
     *
     * @param text Texto com placeholders
     ...
     *
     * <p><b>CRITICAL:</b> MUST be called from main thread.</p>
     *
     * @param text Texto
     * @param player Player alvo
